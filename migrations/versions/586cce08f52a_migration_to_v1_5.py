...
def upgrade() -> None:
    ...
    postgresql.ENUM("subscribed", "trial", "outlaw", name="substate").create(
        op.get_bind()
    )
    ...
    op.add_column("rezident", sa.Column("locale", sa.String(length=8), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("rezident", "locale")
    ...
    postgresql.ENUM("subscribed", "trial", "outlaw", name="substate").drop(
        op.get_bind()
    )
    # ### end Alembic commands ###
