...
def upgrade() -> None:
    ...
    op.add_column("rezident", sa.Column("nom", sa.String(length=64), nullable=True))
    op.add_column("rezident", sa.Column("prenom", sa.String(length=64), nullable=True))
    op.add_column("rezident", sa.Column("promo", sa.String(length=8), nullable=True))
